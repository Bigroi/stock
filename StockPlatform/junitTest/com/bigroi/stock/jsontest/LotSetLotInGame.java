...
public class LotSetLotInGame {
	...
	//private static User user;
		private static Lot lot;
			...
			@Test
			public void setLotInGame() throws DaoException, ParseException{
				LotResourseController res = new LotResourseController();
				String result = res.setLotInGame(lot.getId(), /*new Gson().toJson(user),*/ new Gson().toJson(lot), new HttpSession() {
