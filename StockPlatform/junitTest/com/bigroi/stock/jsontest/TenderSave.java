...
public class TenderSave {
	...
	@Test
	public void tenderEdit() throws DaoException, ParseException{
		TenderResourseController res = new TenderResourseController();
		String result = res.tenderSave(tender.getId(), new Gson().toJson(tender) ,new HttpSession() {
