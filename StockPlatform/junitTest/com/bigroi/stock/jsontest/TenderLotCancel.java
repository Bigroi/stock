...
public class TenderLotCancel {
	...
	public static void init(){
		...
		tender = new Tender();
		tender.setId(12);
		tender.setDescription("lotCancel");
	...
	public void lotCancel() throws DaoException, ParseException{
		...
		String result = res.lotCancel(tender.getId(), new Gson().toJson(tender) ,new HttpSession() {
