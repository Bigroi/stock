...
INSERT INTO `lot` (`id`, `description`, `product_Id`, `min_price`, `seller_Id`, `status`, `exp_date`, `volume`) VALUES
	...
	(11, 'ввв', 1, 10.00, 10, 'CANCELED', '2017-08-25', 600),
	(15, '234234', 111, 11.00, 1, 'CANCELED', '2017-11-18', 123),
	(16, '234234', 111, 11.00, 1, 'CANCELED', '2017-11-18', 1235);
...
INSERT INTO `tender` (`id`, `description`, `product_Id`, `max_price`, `customer_Id`, `status`, `exp_date`, `volume`) VALUES
	(1, 'Javatest', 1, 4.00, 1, 'CANCELED', '2017-08-23', 500),
	(2, 'киви', 126, 3.00, 10, 'CANCELED', '2017-11-14', 100),
	(3, 'бананы', 111, 2.00, 10, 'CANCELED', '2017-06-28', 16),
	(11, 'Javatest', 1, 4.00, 1, 'CANCELED', '2017-07-10', 170),
	(12, 'lotCancel', 1, 0.00, 1, 'CANCELED', '2017-08-23', 6663),
