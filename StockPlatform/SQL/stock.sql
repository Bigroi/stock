...
-- Dumping data for table stock.invite_user: ~1 rows (approximately)
...
-- Dumping data for table stock.user: ~6 rows (approximately)
...
-- Dumping data for table stock.user_role: ~6 rows (approximately)
