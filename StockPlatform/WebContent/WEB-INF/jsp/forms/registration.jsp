		...
		<div class="flex-input">
			...
			<div class="for-checkbox">
				<div class="checkbox-title">
				    ...
				    <span>${label.account.accept}<a href="${pageContext.request.contextPath}/Static/pdf/agree.pdf?version=1" target="_blank"><span>${label.account.termsOfUse}</span></a></span>
				</div>
			</div>
		</div>
