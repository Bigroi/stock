...
public abstract class Bid {
    ...
    public boolean isExpired() {
        return DateUtil.isBeforeToday(exparationDate);
    }
    ...
    public void setAlertBool(boolean alert) {
        this.alert = alert ? "Y" : "N";
    }
    ...
    public boolean isAlertBool() {
        return alert != null && alert.equals("Y");
    }
}
